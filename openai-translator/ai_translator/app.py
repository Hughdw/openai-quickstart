...
# 上传文件保存路径
UPLOAD_FOLDER = '/Users/hughdwong/Temp/flaskTempUpload/'
...
def file_translate(filename):
    ...
    newModel = OpenAIModel(model='gpt-3.5-turbo', api_key='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')
